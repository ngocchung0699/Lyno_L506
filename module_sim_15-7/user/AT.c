...
const AT_CommandTypeDef AT_CheckList[]=
{
    ...
    {AT_CheckSim,           {(uint8_t*) "AT+CPIN?\r\n",                                      10},      {(uint8_t*) "+CPIN",             5},     {(uint8_t*) "OK",       2},  4 },// \r\n+CPIN: READY\r\n\r\nOK\r\n
    {AT_CheckSignal,        {(uint8_t*) "AT+CSQ\r\n",                                         8},      {(uint8_t*) "+CSQ",               3},     {(uint8_t*) "OK",       2},  4 },// \r\n+CSQ: 12,99\r\n\r\nOK\r\n
    {AT_CheckSubscribe,     {(uint8_t*) "AT+CREG?\r\n",                                      10},      {(uint8_t*) "+CREG",             5},     {(uint8_t*) "OK",       2},  4 },// \r\n+CREG: 0,1\r\n\r\nOK\r\n
    {AT_CheckGPRS,          {(uint8_t*) "AT+CGATT?\r\n",                                     11},      {(uint8_t*) "+CGATT",            6},     {(uint8_t*) "OK",       2},  4 },// \r\n+CGATT: 1\r\n\r\nOK\r\n
    ...
    {AT_SendData,           {(uint8_t*) "AT+CIPSEND=1,,,,\r\n",                              18},      {(uint8_t*) "+CIPSEND:SUCCESS", 16},     {(uint8_t*) "\r\n",     2},  4 },// \r\nOK\r\n\r\n+CIPSEND:SUCCESS,1,4,4\r\n
    {AT_GetTime,            {(uint8_t*) "AT+CCLK?\r\n",                                      10},      {(uint8_t*) "+CCLK",             5},     {(uint8_t*) "OK",       2},  4 } // \r\n+CCLK: "22/07/13,10:26:04+28"\r\n\r\nOK\r\n
