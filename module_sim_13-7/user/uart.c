...
int  UART1_CouterData=0, UART1_CouterData=0;
uint8_t UART3_Rx, UART1_Rx;
char UART3_RxDataBuffer[100], UART1_RxDataBuffer[100], UART3_RxData[100], UART1_RxData[100];
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart){
	...
	if(huart->Instance == huart1.Instance)
  {
    ...
    UART1_RxDataBuffer[UART1_CouterData] = UART1_Rx;
    UART1_CouterData++;
	}
